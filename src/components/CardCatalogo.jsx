const CardCatalogo = ({ imagenURL, nombre, mostrarTachado, precio, contenido, colores, etiqueta, contenidoEtiqueta }) => {
  ...
  return (
    <div className={`w-[20em] h-[30em] mt-5 ml-2 mr-2 mx-auto bg-white border border-colorBordes mb-5 text-center overflow-hidden cursor-pointer select-none transition-transform transform-gpu duration-300 lg:hover:scale-105 lg:hover:shadow-lg ${etiqueta ? 'space-y-4' : 'space-y-8'}`}>
